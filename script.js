/* ------ JavaScript - HTML Canvas Particles - HSL Color Gradient - Applied Gradient ------ */
...
class Particle {
    ...
    draw(){
        ...
        ctx.fillStyle = 'hsl(' + hue + ', 100%, 50%)'; // this is the color control.
        ctx.fill();
    }
    update(){
        this.x += this.speedX;
...
function animate(){
    ...
    ctx.fillStyle = 'rgba(255,255,255,0.05)'; // this will leave semi transparent trails beacause of the alpha value. Dissable clearRect above for this to work.
